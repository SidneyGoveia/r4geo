...
---
2016 | Prefeitura Municipal da Estância de Socorro | Socorro - SP
...
---
2015 | Prefeitura Municipal de São Paulo | São Paulo – SP
...
---
2015 | Detran - Roraima |Boa Vista - RR

**Projeto: Treinamento para desenvolvimento de Servidor de Mapas com QGIS Server**

- Assessoria no desenvolvimento de Geoportal dos acidentes de trânsito na cidade de Boa Vista – RR.

---
2015 | Universidade Federal do Piauí – UFPI | Parnaíba - PI
...
---
2015 | Prefeitura Municipal de Brusque | Brusque – SC
...
---
2015 | COBRAPE – Companhia Brasileira de Projetos e Empreendimentos |São Paulo – SP
...
**Projeto: Base Comum de Conhecimento Cidadão - BCCC**

- Capacitação de técnicos da Fundação Tide Azevedo Setúbal (Banco Itaú) em Sistemas de Informações Geográficas

---
2007

APA de Cairuçu e Estação Ecológica de Tamoios – Angra dos Reis

Paraty - RJ

**Treinamento em Sistemas de Informações Geográficas**

- Capacitação dos Técnicos do IBAMA no uso de ferramentas de Geoprocessamento
...
- Participação na capacitação de jovens em SIG e treinamento em TerraView

---
2006

Instituto de Geociências-USP / Instituto Geográfico e Cartográfico – SEP/SP

São Paulo - SP

**Projeto: Carta Imagem da Bacia do Ribeira de Iguape e Litoral Sul**

- Sistema de Informações Geográficas (edição em CD) e 6 folhas de carta-imagem a 1:100.000  (Cartas, mapas ou similares/Carta).
...
**Projeto: Mapa Geológico da Bacia Hidrográfica do Ribeira de Iguape e Litoral Sul**

- Vetorização e compilação dos mapas geológicos do IPT/SP, CPRM e Mineropar;
- Integração dos mapas geológicos;
- Produção do Mapa Geológico da Bacia Hidrográfica e Litoral Sul.
...
**Projeto: Sistema de Informações da Bacia Hidrográfica do Ribeira de Iguape e Litoral Sul**

- Curso “Introdução ao Geoprocessamento através do programa Spring”;
- Montagem do Sistema de Informação do SIG-RB
...
**Projeto: Unidades de Conservação do Vale do Ribeira/SP.  FAPESP000/03**

- Cartografia Digital;
- Processamento  Digital de Imagens de Satelite.
...
**Estágio - Projeto: Sistema de Cadastramento de Poços de Captação de Águas Subterrâneas nas Unidades de Negócio da SABESP.**

- Edição do Mapa Base (Municipios, Unidades de Negócios).
- Programação do SGBD para o cadastramento dos poços.
- Vinculação da Base Cartográfica com o Sistema de Banco de Dados.
...
**Projeto: Banco de Dados Espaciais da Bacia do Alto Tietê – FEHIDRO: 033/98 IGUSP/FUSP/DAEE.**

- Escaneirização e Vetorização de Mapas 1:50.000.
- Edição do Mapa Geológico da RMSP (integração dos mapas 1:50.000) - *ArcInfo Workstation*.
